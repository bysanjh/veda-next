  ...
  return (
    <div className="flex flex-col gap-[12px] w-full msg-in">
      ...
      <button
        ...
        style={{ backgroundColor: '#2e2065', height: 91 }}
      >
        ...
        <div className="absolute flex flex-col gap-[10px]" style={{ left: 16, top: '50%', transform: 'translateY(-50%)', width: 220 }}>
          <p className="font-roboto font-normal text-white text-[18px] m-0" style={{ letterSpacing: '-0.72px', lineHeight: '20px', fontVariationSettings: "'wdth' 100" }}>
            Yes/No Tarot
          </p>
          <p className="font-roboto font-normal text-[14px] m-0" style={{ color: '#cfcfcf', letterSpacing: '-0.56px', lineHeight: '14px', fontVariationSettings: "'wdth' 100" }}>
      ...
      >
        ...
        {[-45, -60, -75].map((deg, i) => (
          <div key={i} className="absolute flex items-center justify-center" style={{ left: 230 + i * 12, top: -30, width: 120, height: 130 }}>
            <div style={{ transform: `rotate(${deg}deg) scaleY(-1)`, position: 'relative', width: 82, height: 120, borderRadius: 3, overflow: 'hidden' }}>
